                        ...
                        <div class="post-inner">
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html">
                                        <img src="{{ (!empty($user->photo)) ? url('upload/images/user/'.$user->photo) : url('upload/images/no_image.jpg') }}"
                                            alt=""></a></figure>
                            ...
                            <div class="lower-content">
                                <form action="{{ route('user.profile.update') }}" method="post" class="default-form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="showImage"
                                            src="{{ (!empty($user->photo)) ? url('upload/images/user/'.$user->photo) : url('upload/images/no_image.jpg') }}"
