            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('property.update') }}" id="myForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $property->state }}"
                                            name="state">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="property_video" value="{{ $property->property_video }}"
                                            class="form-control">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-4">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('property.update.multiimage') }}" id="myForm"
                            enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('property.delete.multiimage', $img->id) }}"
                        ...
                        <form action="{{ route('property.store.multiimage') }}" method="post" id="myForm"
                            enctype="multipart/form-data">
                            @csrf
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $(document).on("click",".addeventmore",function(){
            ...
            $(this).closest(".whole_extra_item_delete").append(whole_extra_item_add);
            counter++;
      });
