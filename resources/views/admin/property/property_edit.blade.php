                        ...
                        <form method="post" action="{{ route('property.store') }}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $property->state }}" name="state">
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-3">
                                    <div class="mb-3">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_descp" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $property->short_description }}</textarea>
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label">Long Description</label>
                                    <textarea class="form-control" name="long_descp" id="tinymceExample" rows="10">{{ $property->long_description }}</textarea>
                                </div>
                            </div><!-- Col -->
                            <hr>
                            <div class="mb-3">
