...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <a href="{{ route('admin.agent.create') }}" class="btn btn-inverse-info"> Add Agent </a>
        </ol>
    </nav>
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><img src="{{ (!empty($item->photo)) ? url('upload/agent/profile/'.$item->photo) : url('upload/images/no_image.jpg') }}"
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.agent.edit', $item->id) }}"
                                            class="btn btn-inverse-warning" title="Edit"> <i data-feather="edit"></i>
                                        </a>

                                        <a href="{{ route('admin.agent.delete', $item->id) }}"
